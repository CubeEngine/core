...
public class General  //TODO remove this class
{
    ...
    public String randomDeathMessage(User user, EntityDamageByEntityEvent lastDmg)
    {
         ...
         * {
         * s = _(user, "basics", "&c%s was slain by %s",
         * user.getName(),((Player)lastDmg.getDamager()).getName());
         * }
         * else
         * {
         * s = _(user, "basics", "&c%s was slain by %s",
         * user.getName(),lastDmg.getDamager().toString());
         * }
         * }
         ...
         * {
         * s = _(user, "basics", "&c%s was shot by %s",
         * user.getName(),((Player)lastDmg.getDamager()).getName());
         * }
         * else
         * {
         * if (projectile.getShooter() instanceof Ghast
         * ||projectile.getShooter() instanceof Blaze)
         * s = _(user, "basics", "&c%s was fireballed by %s",
         * user.getName(),lastDmg.getDamager().toString());
