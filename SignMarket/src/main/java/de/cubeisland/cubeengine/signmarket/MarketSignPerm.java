...
public enum MarketSignPerm implements Permission
{
    ...
    SIGN_CREATE_USER,
    SIGN_CREATE_ADMIN, SIGN_CREATE_ADMIN_BUY, SIGN_CREATE_USER_BUY, SIGN_CREATE_USER_SELL, SIGN_CREATE_ADMIN_SELL, SIGN_CREATE_USER_OTHER, SIGN_CREATE_ADMIN_STOCK, SIGN_CREATE_ADMIN_NOSTOCK, SIGN_CREATE, SIGN_EDIT, SIGN_SETSTOCK;
