...
public class ConomyPermissions extends PermissionContainer
{
    ...
    private static final Permission CONOMY = BASEPERM.createAbstractChild("conomy");
    private static final Permission ACCOUNT = CONOMY.createAbstractChild("account");

    public static final Permission ACCOUNT_ALLOWUNDERMIN = CONOMY.createChild("allowundermin");
    public static final Permission ACCOUNT_SHOWHIDDEN = CONOMY.createChild("showhidden");
