...
public class GroupControl
{
    ...
    public GroupControl(ConfigurationSection config)
    {
        for (String name : config.getKeys(false))
        {
            ...
            {
                newGroup.setBit(Group.ECONOMY_BANK);
            }
            ...
            {
                newGroup.setBit(Group.POWER_LOSS);
            }
            if (section.getBoolean("power.powergain"))
            {
                newGroup.setBit(Group.POWER_GAIN);
            }
            if (section.getBoolean("pvp.PvP"))
            {
                newGroup.setBit(Group.PVP_ON);
            }
            if (section.getBoolean("pvp.damage"))
            {
                newGroup.setBit(Group.PVP_DAMAGE);
            }
            if (section.getBoolean("pvp.friendlyfire"))
            {
                newGroup.setBit(Group.PVP_FRIENDLYFIRE);
            }
            ...
            {
                newGroup.setBit(Group.MONSTER_SPAWN);
            }
            if (section.getBoolean("monster.damage"))
            {
                newGroup.setBit(Group.MONSTER_DAMAGE);
            }
            if (section.getBoolean("build.destroy"))
            {
                newGroup.setBit(Group.BUILD_DESTROY);
            }
            if (section.getBoolean("build.place"))
            {
                newGroup.setBit(Group.BUILD_PLACE);
            }
            ...
            {
                newGroup.setBit(Group.USE_FIRE);
            }
            if (section.getBoolean("use.lava"))
            {
                newGroup.setBit(Group.USE_LAVA);
            }
            if (section.getBoolean("use.water"))
            {
                newGroup.setBit(Group.USE_WATER);
            }
