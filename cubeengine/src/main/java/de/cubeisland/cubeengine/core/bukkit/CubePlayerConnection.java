...
import net.minecraft.server.v1_6_R1.Packet105CraftProgressBar;
import net.minecraft.server.v1_6_R1.Packet106Transaction;
import net.minecraft.server.v1_6_R1.Packet107SetCreativeSlot;
import net.minecraft.server.v1_6_R1.Packet108ButtonClick;
import net.minecraft.server.v1_6_R1.Packet10Flying;
import net.minecraft.server.v1_6_R1.Packet130UpdateSign;
import net.minecraft.server.v1_6_R1.Packet131ItemData;
import net.minecraft.server.v1_6_R1.Packet132TileEntityData;
...
import net.minecraft.server.v1_6_R1.Packet1Login;
import net.minecraft.server.v1_6_R1.Packet200Statistic;
import net.minecraft.server.v1_6_R1.Packet201PlayerInfo;
import net.minecraft.server.v1_6_R1.Packet202Abilities;
import net.minecraft.server.v1_6_R1.Packet203TabComplete;
import net.minecraft.server.v1_6_R1.Packet204LocaleAndViewDistance;
...
import net.minecraft.server.v1_6_R1.Packet252KeyResponse;
import net.minecraft.server.v1_6_R1.Packet253KeyRequest;
import net.minecraft.server.v1_6_R1.Packet254GetInfo;
import net.minecraft.server.v1_6_R1.Packet255KickDisconnect;
import net.minecraft.server.v1_6_R1.Packet25EntityPainting;
import net.minecraft.server.v1_6_R1.Packet26AddExpOrb;
import net.minecraft.server.v1_6_R1.Packet27PlayerInput;
import net.minecraft.server.v1_6_R1.Packet28EntityVelocity;
import net.minecraft.server.v1_6_R1.Packet29DestroyEntity;
import net.minecraft.server.v1_6_R1.Packet2Handshake;
...
import net.minecraft.server.v1_6_R1.Packet39AttachEntity;
...
import net.minecraft.server.v1_6_R1.Packet4UpdateTime;
import net.minecraft.server.v1_6_R1.Packet51MapChunk;
import net.minecraft.server.v1_6_R1.Packet52MultiBlockChange;
import net.minecraft.server.v1_6_R1.Packet53BlockChange;
import net.minecraft.server.v1_6_R1.Packet54PlayNoteBlock;
import net.minecraft.server.v1_6_R1.Packet55BlockBreakAnimation;
...
import net.minecraft.server.v1_6_R1.Packet6SpawnPosition;
import net.minecraft.server.v1_6_R1.Packet70Bed;
import net.minecraft.server.v1_6_R1.Packet71Weather;
...
public class CubePlayerConnection extends PlayerConnection
{
    ...
    {
        if (this.packetReceived(packet101closewindow))
            return;
    ...
    {
        if (this.packetReceived(packet27playerinput))
            return;
