...
import net.minecraft.server.v1_6_R2.Packet105CraftProgressBar;
...
import net.minecraft.server.v1_6_R2.Packet131ItemData;
import net.minecraft.server.v1_6_R2.Packet132TileEntityData;
...
import net.minecraft.server.v1_6_R2.Packet1Login;
import net.minecraft.server.v1_6_R2.Packet200Statistic;
...
import net.minecraft.server.v1_6_R2.Packet252KeyResponse;
import net.minecraft.server.v1_6_R2.Packet253KeyRequest;
import net.minecraft.server.v1_6_R2.Packet254GetInfo;
import net.minecraft.server.v1_6_R2.Packet255KickDisconnect;
import net.minecraft.server.v1_6_R2.Packet25EntityPainting;
import net.minecraft.server.v1_6_R2.Packet26AddExpOrb;
...
import net.minecraft.server.v1_6_R2.Packet2Handshake;
...
import net.minecraft.server.v1_6_R2.Packet6SpawnPosition;
