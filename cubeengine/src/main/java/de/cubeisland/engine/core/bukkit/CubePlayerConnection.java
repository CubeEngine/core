...
import net.minecraft.server.v1_7_R1.Packet102WindowClick;
import net.minecraft.server.v1_7_R1.Packet103SetSlot;
import net.minecraft.server.v1_7_R1.Packet104WindowItems;
import net.minecraft.server.v1_7_R1.Packet105CraftProgressBar;
import net.minecraft.server.v1_7_R1.Packet106Transaction;
import net.minecraft.server.v1_7_R1.Packet107SetCreativeSlot;
import net.minecraft.server.v1_7_R1.Packet108ButtonClick;
import net.minecraft.server.v1_7_R1.Packet10Flying;
import net.minecraft.server.v1_7_R1.Packet130UpdateSign;
import net.minecraft.server.v1_7_R1.Packet131ItemData;
import net.minecraft.server.v1_7_R1.Packet132TileEntityData;
import net.minecraft.server.v1_7_R1.Packet133OpenTileEntity;
import net.minecraft.server.v1_7_R1.Packet14BlockDig;
import net.minecraft.server.v1_7_R1.Packet15Place;
import net.minecraft.server.v1_7_R1.Packet16BlockItemSwitch;
import net.minecraft.server.v1_7_R1.Packet17EntityLocationAction;
import net.minecraft.server.v1_7_R1.Packet18ArmAnimation;
import net.minecraft.server.v1_7_R1.Packet19EntityAction;
import net.minecraft.server.v1_7_R1.Packet1Login;
import net.minecraft.server.v1_7_R1.Packet200Statistic;
import net.minecraft.server.v1_7_R1.Packet201PlayerInfo;
import net.minecraft.server.v1_7_R1.Packet202Abilities;
import net.minecraft.server.v1_7_R1.Packet203TabComplete;
import net.minecraft.server.v1_7_R1.Packet204LocaleAndViewDistance;
import net.minecraft.server.v1_7_R1.Packet205ClientCommand;
import net.minecraft.server.v1_7_R1.Packet206SetScoreboardObjective;
import net.minecraft.server.v1_7_R1.Packet207SetScoreboardScore;
import net.minecraft.server.v1_7_R1.Packet208SetScoreboardDisplayObjective;
import net.minecraft.server.v1_7_R1.Packet209SetScoreboardTeam;
...
import net.minecraft.server.v1_7_R1.Packet250CustomPayload;
import net.minecraft.server.v1_7_R1.Packet252KeyResponse;
import net.minecraft.server.v1_7_R1.Packet253KeyRequest;
import net.minecraft.server.v1_7_R1.Packet254GetInfo;
import net.minecraft.server.v1_7_R1.Packet255KickDisconnect;
import net.minecraft.server.v1_7_R1.Packet25EntityPainting;
import net.minecraft.server.v1_7_R1.Packet26AddExpOrb;
import net.minecraft.server.v1_7_R1.Packet27PlayerInput;
import net.minecraft.server.v1_7_R1.Packet28EntityVelocity;
import net.minecraft.server.v1_7_R1.Packet29DestroyEntity;
import net.minecraft.server.v1_7_R1.Packet2Handshake;
...
import net.minecraft.server.v1_7_R1.Packet41MobEffect;
import net.minecraft.server.v1_7_R1.Packet42RemoveMobEffect;
import net.minecraft.server.v1_7_R1.Packet43SetExperience;
import net.minecraft.server.v1_7_R1.Packet44UpdateAttributes;
import net.minecraft.server.v1_7_R1.Packet4UpdateTime;
import net.minecraft.server.v1_7_R1.Packet51MapChunk;
import net.minecraft.server.v1_7_R1.Packet52MultiBlockChange;
import net.minecraft.server.v1_7_R1.Packet53BlockChange;
import net.minecraft.server.v1_7_R1.Packet54PlayNoteBlock;
import net.minecraft.server.v1_7_R1.Packet55BlockBreakAnimation;
import net.minecraft.server.v1_7_R1.Packet56MapChunkBulk;
import net.minecraft.server.v1_7_R1.Packet5EntityEquipment;
import net.minecraft.server.v1_7_R1.Packet60Explosion;
import net.minecraft.server.v1_7_R1.Packet61WorldEvent;
import net.minecraft.server.v1_7_R1.Packet62NamedSoundEffect;
import net.minecraft.server.v1_7_R1.Packet63WorldParticles;
import net.minecraft.server.v1_7_R1.Packet6SpawnPosition;
import net.minecraft.server.v1_7_R1.Packet70Bed;
import net.minecraft.server.v1_7_R1.Packet71Weather;
import net.minecraft.server.v1_7_R1.Packet7UseEntity;
import net.minecraft.server.v1_7_R1.Packet8UpdateHealth;
import net.minecraft.server.v1_7_R1.Packet9Respawn;
