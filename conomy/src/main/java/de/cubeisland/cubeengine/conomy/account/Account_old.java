...
public class Account_old
{
    ...
    private final AccountManager_old manager;

    public Account_old(AccountManager_old manager, Currency currency, AccountModel model)
    {
     ...
     */
    public long transaction(Account_old source, long amount) throws IllegalArgumentException
    {
        if (source != null)
        {
