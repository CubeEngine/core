...
public class AliasMapFormat
{
    ...
    {
        return parseStringList(org.cubeengine.service.filesystem.FileUtil.readStringList(file), map, update);
    }
    ...
    {
        Contract.expectNotNull(input, "Invalid input! File or Reader was null!");
        Contract.expectNotNull(map, "Map to parse into was null!");
