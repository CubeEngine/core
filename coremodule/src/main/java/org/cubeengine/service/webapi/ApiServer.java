    ...
    public void registerApiHandlers(final Module owner, final Object holder)
    {
        ...
        for (Method method : holder.getClass().getDeclaredMethods())
        {
            ...
            if (aAction != null)
            {
                ...
                if (method.isAnnotationPresent(org.cubeengine.service.webapi.Method.class))
                {
                    reqMethod = method.getAnnotation(org.cubeengine.service.webapi.Method.class).value();
                }
