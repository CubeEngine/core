    ...
    public void registerApiHandlers(final Module owner, final Object holder)
    {
        ...
        for (Method method : holder.getClass().getDeclaredMethods())
        {
            ...
            if (aAction != null)
            {
                ...
                if (method.isAnnotationPresent(de.cubeisland.engine.module.core.webapi.Method.class))
                {
                    reqMethod = method.getAnnotation(de.cubeisland.engine.module.core.webapi.Method.class).value();
                }
