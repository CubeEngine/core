...
import de.cubeisland.engine.module.core.storage.ModuleRegistry;
import de.cubeisland.engine.module.core.storage.SimpleModuleRegistry;
...
public abstract class Module
{
    ...
    void initialize(Core core, ModuleInfo info, Path folder, ModuleLoader loader, ClassLoader classLoader)
    {
        if (!this.initialized)
        {
            ...
            this.log.addTarget(new AsyncFileTarget(LoggingUtil.getLogFile(core, this.getName()),
                                                   ...
                                                   this.core.getTaskManager().getThreadFactory(this)));
    ...
    {
        Contract.expectNotNull(path, "The path must not be null!");
