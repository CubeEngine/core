 ...
 */
package de.cubeisland.engine.module.core.util.math.shape;

import java.util.Iterator;
import de.cubeisland.engine.module.core.util.math.MathHelper;
import de.cubeisland.engine.module.core.util.math.SquareMatrix3;
