...
public class VectorFormatter extends ReflectedFormatter
{
    ...
    public String format(BlockVector2 v, MacroContext context)
    {
        ...
        {
            return ChatFormat.DARK_AQUA + "[" + ChatFormat.WHITE + arg0 + ChatFormat.GOLD + v.x +
                   ChatFormat.DARK_AQUA + "," + ChatFormat.WHITE + arg1 + ChatFormat.GOLD + v.z + ChatFormat.DARK_AQUA + "]";
        }
        return ChatFormat.DARK_AQUA + "[" + ChatFormat.GOLD + v.x +
               ChatFormat.DARK_AQUA + "," + ChatFormat.GOLD + v.z + ChatFormat.DARK_AQUA + "]";
    }
    ...
    public String format(BlockVector3 v, MacroContext context)
    {
        ...
        {
            return ChatFormat.DARK_AQUA + "[" + ChatFormat.WHITE + arg0 + ChatFormat.GOLD + v.x +
                   ChatFormat.DARK_AQUA + "," + ChatFormat.WHITE + arg1 + ChatFormat.GOLD + v.y + ChatFormat.DARK_AQUA +
                   ChatFormat.DARK_AQUA + "," + ChatFormat.WHITE + arg2 + ChatFormat.GOLD + v.z + ChatFormat.DARK_AQUA + "]";
        }
        return ChatFormat.DARK_AQUA + "[" + ChatFormat.GOLD + v.x +
               ChatFormat.DARK_AQUA + "," + ChatFormat.GOLD + v.y +
               ChatFormat.DARK_AQUA + "," + ChatFormat.GOLD + v.z + ChatFormat.DARK_AQUA + "]";
    }
