 ...
 */
package de.cubeisland.engine.module.core.util.math;

import static de.cubeisland.engine.module.core.util.math.MathHelper.compare;
import static de.cubeisland.engine.module.core.util.math.MathHelper.isZero;
...
public class BlockVector3
{
    ...
    {
        return MathHelper.isZero(this.dot(other));
    }
    ...
    {
        return MathHelper.compare(this.x / other.x, this.y / other.y);
    }
    ...
    public boolean equals(Object o)
    {
        ...
        return MathHelper.compare(this.x, other.x) && MathHelper.compare(this.y, other.y) && MathHelper.compare(this.z,
                                                                                                                other.z);
    }
