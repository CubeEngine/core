...
public class Permission
{
     ...
     */
    public static final Permission BASE = new Permission("cubeengine", PermDefault.FALSE, true); // cubeengine.*
    ...
    {
        return this.newPerm(name, PermDefault.OP);
    }
    ...
    {
        return this.newWildcard(name, PermDefault.FALSE);
    }
    ...
    {
        return this.child(name, PermDefault.OP);
    }
    ...
    {
        return this.childWildcard(name, PermDefault.FALSE);
    }
    ...
    {
        Contract.expectNotNull(permissible, "The permissible may not be null!");
    ...
    public boolean isAuthorized(CommandSender user)
    {
        ...
        return user.hasPermission(this.getFullName());
    }
