...
public class RemoveCommand
{
    ...
    @Command(usage = "<AuctionId>", aliases =
    {
        "cancel", "delete", "rem"
    })
    public boolean remove(CommandSender sender, CommandArgs args)
    {
        ...
        if (args.hasFlag("p"))
        {
            ...
            else
            {
                ...
                {
                    if (!Perm.command_delete_player.check(sender))
                    {
                        return true;
                    }
                    else if (!Perm.command_delete_player_other.check(sender))
                    {
                        return true;
                    }
                }
        ...
        if (args.getString(0) != null)
        {
            ...
            {
                if (!Perm.command_delete_all.check(sender))
                {
                    return true;
                }
            ...
            else
            {
                ...
                {
                    if (!Perm.command_delete_server.check(sender))
                    {
                        return true;
                    }
            ...
            }
            {
                ...
                if (id != null)
                {
                    if (!Perm.command_delete_id.check(sender))
                    {
                        return true;
                    }
                    ...
                    {
                        if (!Perm.command_delete_player_other.check(sender))
                        {
                            return true;
                        }
                    }
