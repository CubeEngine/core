...
public class SignChangLog extends AbstractLog
{
    ...
    @DatabaseConstructor
    public SignChangLog(List<Object> args) throws ConversionException
    {
    ...
    public SignChangLog(Player user, BlockState state, String[] oldLines, String[] newLines)
    {
