...
public class FunCommands
{
    ...
    @Command(names = {
        "throw"
    }, desc = "The CommandSender throws a certain amount of snowballs or eggs. Default is one.", min = 1, max = 2, usage = "<egg|snowball> [amount]")
    ...
    @Command(desc = "The CommandSender throws a certain amount of fireballs. Default is one.", max = 1, usage = "[amount]")
    ...
    @Command(desc = "rockets a player", max = 1, usage = "[height]", params = @Param(names = {
        "player", "p"
    }, type = User.class))
