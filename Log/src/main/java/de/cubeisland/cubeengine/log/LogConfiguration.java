...
public class LogConfiguration extends Configuration
{
    ...
    @Comment("Filling a bucket with milk.") //TODO filling mushroom bowl? or just ignore that
    @Option("logging.block.bucket.fill-milk")
    public boolean BUCKET_FILL_milk = false; // TODO
    ...
    public Collection<Material> breakNoLogging = new LinkedList<Material>();
    ...
    @Comment("Items picked up by a player OR zombie") //TODO zombie item pickup!!!
    ...
    @Option("logging.container.type.other")
    public boolean containerOther = false;
    ...
    public List<String> PLAYER_COMMAND_ignoreRegex = new ArrayList<String>();//TODO add default CE pw setting
