...
public class QueuedLog
{
    ...
    public QueuedLog(Timestamp timestamp, Long worldID, Integer x, Integer y, Integer z, int action, Long causer, String block, Long data, String newBlock, Byte newData, String additionalData)
    {
