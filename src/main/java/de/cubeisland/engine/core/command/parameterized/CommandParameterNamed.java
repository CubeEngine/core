...
public class CommandParameterNamed extends NamedParameter
{
    protected final Permission permission;

    public CommandParameterNamed(String name, Class<?> type, Class<?> reader, int greed, boolean required,
    ...
    public CommandParameterNamed(String name, Class<?> type, boolean required, String label, String description,
    ...
    public CommandParameterNamed(String name, String label, Class<?> type)
    {
    ...
    public CommandParameterNamed withCompleter(Completer completer)
    {
