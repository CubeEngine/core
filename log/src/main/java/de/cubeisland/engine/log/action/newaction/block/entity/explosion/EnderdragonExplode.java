...
public class EnderdragonExplode extends ExplosionActionType
{
    ...
    {
        return action instanceof EnderdragonExplode
            && this.oldBlock.equals(((EnderdragonExplode)action).oldBlock)
            && this.entity.equals(((EnderdragonExplode)action).entity)
            && ((this.player == null && ((EnderdragonExplode)action).player == null)
            || (this.player != null && this.player.equals(((EnderdragonExplode)action).player)));
    }
    ...
    public String translateAction(User user)
    {
        ...
        if (this.player == null)
        {
            return user.getTranslationN(POSITIVE, count,
                                        "An enderdragon changed the integrity of {name#block}",
