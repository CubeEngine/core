...
public class MonsterEggUse extends EntityActionType<EntityListener>
{
    ...
    {
        return action instanceof MonsterEggUse
            && this.entity.isSameType(((MonsterEggUse)action).entity)
    ...
    public String translateAction(User user)
    {
        ...
        return user.getTranslationN(POSITIVE, count,
                                    "{user} spawned {name#entity} using a spawnegg",
                                    "{user} spawned {name#entity} using a spawnegg {amount} times",
