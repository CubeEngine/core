...
public class WaterBucket extends BlockActionType
{
    ...
    protected void showLogEntry(User user, LogEntry logEntry, String time, String loc)
    {
        if (logEntry.hasAttached())
        {
            ...
            user.sendTranslated(, "&2%s &aemptied &6&d&a water-buckets", logEntry.getCauserUser().getDisplayName(), amount);
        }
        else
        {
            user.sendTranslated(, "&2%s &aemptied a water-bucket", logEntry.getCauserUser().getDisplayName());
        }
    }
