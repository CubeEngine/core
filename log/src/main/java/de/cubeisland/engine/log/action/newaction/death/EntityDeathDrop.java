 ...
 */
public class EntityDeathDrop extends BaseAction<DeathListener>
{
    ...
    {
        return action instanceof EntityDeathDrop && this.death != null && ((EntityDeathDrop)action).death != null
