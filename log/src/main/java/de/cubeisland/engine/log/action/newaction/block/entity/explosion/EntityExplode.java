...
public class EntityExplode extends EntityBlockActionType<ExplodeListener>
{
    ...
    {
        return action instanceof EntityExplode
            && this.oldBlock.equals(((EntityExplode)action).oldBlock)
    ...
    public String translateAction(User user)
    {
        ...
        return user.getTranslationN(POSITIVE, count,
                                    "Something blew up {name#block}",
                                    "Something blew up {1:amount}x {name#block}",
