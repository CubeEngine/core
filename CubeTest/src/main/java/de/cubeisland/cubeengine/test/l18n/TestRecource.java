...
{
    GERMAN_MESSAGES("resource/language/messages/de_DE.json", "language/de_DE/test.json"),
    FRENSH_MESSAGES("resource/language/messages/fr_FR.json", "language/fr_FR/test.json");
